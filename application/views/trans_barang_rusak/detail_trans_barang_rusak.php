                    ...
                    <div class="card-body">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <input type="hidden" id="id_faktur" name="id_faktur" value="id"/>
                            </div>
                        </div>
                        <br>
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="text" class="myinput text-center" id="tgl_faktur" name="tgl_faktur" value="<?= tgl_indo($data_faktur[0]->tgl_faktur) ?>" readonly/>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-lg-6">
                    ...
                    <tbody>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-center"><?= number_format($row->jumlah_buah, 0, ',', '.'); ?></td>
                                <td class="text-center"><?= number_format($row->jumlah_kulit, 0, ',', '.'); ?></td>
                                <td class="text-center"><?= number_format($row->jumlah_bonggol, 0, ',', '.'); ?></td>
                                <td class="text-center"><?= number_format($row->jumlah_lain, 0, ',', '.'); ?></td>
                                <td class="text-center"><?= number_format($row->jumlah_buah + $row->jumlah_kulit + $row->jumlah_bonggol + $row->jumlah_lain, 0, ',', '.'); ?></td>

...
<div class="main-content">
    ...
    <section class="section">
        ...
        <div class="row">
                ...
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4 style="font-size: 12px;">Total Faktur Barang Rusak <span class="text-primary"></span></h4>
                        </div>
                        <div class="card-body">
            ...
            <div class="col-lg-6 ">
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4 style="font-size: 12px;">Total Barang Rusak <span class="text-primary"></span></h4>
                        </div>
                        <div class="card-body">
                            <span id="show_total_rusak">Rp. <?= number_format($total_rusak, 2, ',', '.') ?></span>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <select class="form-group select2" id="filter_gudang" <?= activeOutlet() ? "disabled" : "" ?>>
        ...
        <div class="row">
            <div class="col-lg-12">
                <a href="<?= base_url(); ?>barang_rusak/show/tambah" class="btn btn-lg btn-primary mb-3 font-weight-bold">
                    Tambah Faktur Barang Rusak
                </a>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#tabel-show').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('barang_rusak/ajax_list')?>",
                "type": "POST",
                "data": function ( data ) {

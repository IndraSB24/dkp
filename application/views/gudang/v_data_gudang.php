    ...
    <section class="section">
        <div class="row mt-5">
            <div class="col-lg-12 mt-2">
                ...
                <button class="btn btn-lg btn-primary mb-3 font-weight-bold" data-toggle="modal" data-target="#form_tambah">Tambah Gudang</button>
                <table class="table table-bordered table-light shadow-sm p-3 mb-5 bg-white rounded dt-responsive wrap" id="tabel-produk" width="100%">
                    <thead>
                        <tr>
                        ...
                        ?>
                            <tr>
                                ...
                                <td class="text-capitalize">
                                    <a href="<?= base_url().'data_divisi/data_divisi/'.$row['id'].'/'.$row['nama'] ?>">
                                        <?= $row['nama']; ?>
                                    </a>
                                </td>
                                ...
                                <td class="text-center">
                                    ...
                                    <!-- Button Hapus -->
                                    <a href="<?= base_url(); ?>data_gudang/hapus/<?= $row['id']; ?>" class="btn btn-sm btn-danger text-light tombol-hapus"><i class="fas fa-trash-alt"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
                    </tbody>
    ...
    <div class="modal-dialog mt-5">
        <div class="modal-content">
            <div class="modal-header bg-primary" style="color:white">
                <h5 class="modal-title" id="staticBackdropLabel">Tambah Data Gudang</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form action="<?= base_url(); ?>data_gudang/tambah" method="POST">
                <div class="modal-body">
                    <div class="form-group">
                        <label for="nama_satuan">Nama Gudang</label>
                        <input type="text" class="form-control" id="nama" name="nama" autocomplete="off" placeholder="Masukkan Nama Gudang . . ." />
                    </div>
                    <div class="form-group">
    ...
    <div class="modal-dialog mt-5" >
        <div class="modal-content">
            <div class="modal-header bg-success" style="color:white">
                <h5 class="modal-title" id="staticBackdropLabel">Edit Data Gudang</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <form id="form_edit_<?= $row['id']; ?>" action="<?= base_url(); ?>data_gudang/update" method="POST">
                <div class="modal-body">
                    ...
                    <div class="form-group">
                        <label for="kota">Kota</label>
                        <select class="form-control select2" id="kota_edit" name="kota_edit" >
                            <option value="">Pilih Kota</option>
                            <?php 
                                foreach ($list_kota as $kota){
                                    echo '<option value="'.$kota['id'].'"> '.$kota['nama'].' </option>';

                ...
                <div class="card card-statistic-2">
                    ...
                    <div class="card-wrap">
                        <div class="card-header">
                            <h4 style="font-size: 12px;">Total Outlet Terhutang <span class="text-primary"></span></h4>
                        </div>
                        <div class="card-body">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                ...
                                <select class="form-group select2" id="filter_outlet">
                ...
                <table class="table table-bordered table-light shadow-sm p-3 mb-5 bg-white rounded dt-responsive nowrap" id="tabel-show" width="100%">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center">Jumlah Faktur Piutang</th>
...
<script>
    ...
    $(document).ready(function() {
        ...
        table = $('#tabel-show').DataTable({
            ...
            "ajax": {
                "url": "<?php echo site_url('daftar_piutang/ajax_list')?>",
                "type": "POST",
                "data": function ( data ) {

...
class Kategori_entitas extends CI_Controller
{
    public function __construct()
    {
        ...
        $this->load->model('Model_kategori_entitas');
    }
    ...
    public function data()
    {
        ...
        $data['title']  = 'Data Kategori Entitas';
        $data['data_kategori_entitas']= $this->Model_kategori_entitas->get_all($user_id);
        $this->load->view('template/header', $data);
        $this->load->view('template/sidebar');
        $this->load->view('kategori_entitas/index', $data);
